 ...
 */
export const DoorVariant = new SimpleSchema({
  _id: {
    type: String,
    label: "Variant ID",
  },
 ...
 * @type {SimpleSchema}
 * @memberof Schemas
 * @property {String} _id Door ID
 * @property {String[]} ancestors default value: `[]`
 * @property {Date} createdAt required
 * @property {String} currentDoorHash optional
 * @property {String} description optional
 ...
 * @property {String} doorType optional
 * @property {Date} publishedAt optional
 * @property {String} publishedDoorHash optional
 * @property {String} shopId Door ShopID
 * @property {Boolean} shouldAppearInSitemap optional, whether this door should appear in auto-generated sitemap.xml
 * @property {String[]} supportedFulfillmentTypes Types of fulfillment ("shipping", "pickup", etc) allowed for this door
 * @property {String} template optional
 * @property {String} title Door Title
 ...
 * @property {Workflow} workflow optional
 */
export const Door = new SimpleSchema({
  _id: {
    type: String,
    label: "Door ID",
  },
...
export const DoorVariantInputSchema = new SimpleSchema({});
