 ...
 */
export const UnitVariant = new SimpleSchema({
  _id: {
    type: String,
    label: "Variant ID",
  },
 ...
 * @type {SimpleSchema}
 * @memberof Schemas
 * @property {String} _id Unit ID
 * @property {String[]} ancestors default value: `[]`
 * @property {Date} createdAt required
 * @property {String} currentUnitHash optional
 * @property {String} description optional
 ...
 * @property {String} unitType optional
 * @property {Date} publishedAt optional
 * @property {String} publishedUnitHash optional
 * @property {String} shopId Unit ShopID
 * @property {Boolean} shouldAppearInSitemap optional, whether this unit should appear in auto-generated sitemap.xml
 * @property {String[]} supportedFulfillmentTypes Types of fulfillment ("shipping", "pickup", etc) allowed for this unit
 ...
 * @property {Workflow} workflow optional
 */
export const Unit = new SimpleSchema({
  _id: {
    type: String,
    label: "Unit ID",
  },
...
export const UnitVariantInputSchema = new SimpleSchema({});
